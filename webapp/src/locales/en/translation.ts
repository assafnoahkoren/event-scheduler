export const enTranslation = {
  ...
  componentTypes: {
    ...
    newComponentType: "New Component Type",
    createComponentType: "Create Component Type",
    editComponentType: "Edit Component Type",
    componentTypeDescription: "Define reusable component types for floor plan layouts",
    noComponentTypes: "No component types yet",
    noComponentTypesDescription: "Create component types like tables, chairs, and stages to use in floor plan layouts",
    noComponentTypesFound: "No component types found",
    searchComponentTypes: "Search component types...",
    tryAdjustingSearch: "Try adjusting your search",
    name: "Name",
    namePlaceholder: "Table, Chair, Stage, etc.",
    category: "Category",
    categoryPlaceholder: "Furniture, Equipment, etc.",
    defaultWidth: "Default Width",
    defaultHeight: "Default Height",
    occupancy: "Occupancy",
    occupancyPlaceholder: "Number of people",
    color: "Color",
    borderRadius: "Border Radius",
    round: "Round",
    createSuccess: "Component type created successfully",
    createError: "Failed to create component type",
    updateSuccess: "Component type updated successfully",
    updateError: "Failed to update component type",
    deleteSuccess: "Component type deleted successfully",
  ...
  stock: {
    ...
    category: {
      name: 'Category Name',
      namePlaceholder: 'e.g. Beverages, Food, Cleaning',
