...
export const heTranslation: TranslationType = {
  ...
  eventFloorPlan: {
    tab: 'סקיצה',
    empty: 'אין עדיין סקיצה',
    emptyDescription: 'הוסף פריסת סקיצה לאירוע זה, מועתקת מתבנית.',
    add: 'הוסף סקיצה',
    pickerTitle: 'בחר תבנית',
    noTemplates: 'אין תבניות זמינות. צור תחילה סקיצה ותבנית לאתר זה.',
    open: 'פתח',
    remove: 'הסר',
    items_one: 'פריט אחד',
    ...
    removeTitle: 'להסיר את הסקיצה?',
    removeDescription: 'פעולה זו מוחקת את פריסת הסקיצה של האירוע. התבנית המקורית אינה מושפעת.',
    created: 'הסקיצה נוספה',
    createError: 'הוספת הסקיצה נכשלה',
    removed: 'הסקיצה הוסרה',
  ...
  componentTypes: {
    title: "סוגי רכיבים",
    newComponentType: "סוג רכיב חדש",
    createComponentType: "צור סוג רכיב",
    editComponentType: "ערוך סוג רכיב",
    componentTypeDescription: "הגדר סוגי רכיבים לשימוש חוזר בפריסות תוכניות קומה",
    noComponentTypes: "אין סוגי רכיבים עדיין",
    noComponentTypesDescription: "צור סוגי רכיבים כמו שולחנות, כיסאות ובמות לשימוש בפריסות תוכניות קומה",
    noComponentTypesFound: "לא נמצאו סוגי רכיבים",
    searchComponentTypes: "חפש סוגי רכיבים...",
    tryAdjustingSearch: "נסה להתאים את החיפוש",
    name: "שם",
    namePlaceholder: "שולחן, כיסא, במה וכו'",
    category: "קטגוריה",
    categoryPlaceholder: "ריהוט, ציוד וכו'",
    defaultWidth: "רוחב ברירת מחדל",
    defaultHeight: "גובה ברירת מחדל",
    occupancy: "תפוסה",
    occupancyPlaceholder: "מספר אנשים",
    color: "צבע",
    borderRadius: "רדיוס פינות",
    round: "עגול",
    createSuccess: "סוג הרכיב נוצר בהצלחה",
    createError: "יצירת סוג הרכיב נכשלה",
    updateSuccess: "סוג הרכיב עודכן בהצלחה",
    updateError: "עדכון סוג הרכיב נכשל",
    deleteSuccess: "סוג הרכיב נמחק בהצלחה",
  ...
  stock: {
    ...
    common: {
      ...
      submit: 'שלח',
      close: 'סגור',
      confirmArrival: 'אשר קבלה',
      logMovement: 'רשום תנועה',
      ...
      decrease: 'הפחת',
      increase: 'הגדל',
      decreaseBy: 'הפחת ב-{{amount}}',
      increaseBy: 'הגדל ב-{{amount}}',
    },
    actions: {
    ...
    category: {
      name: 'שם קטגוריה',
      namePlaceholder: 'לדוגמה: משקאות, אוכל, ניקיון',
